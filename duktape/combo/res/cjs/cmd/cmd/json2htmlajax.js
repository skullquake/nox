{
	...
	json2htmlajax.prototype.src='res/cjs/cmd/cmd/json2htmlajax.js';
	json2htmlajax.prototype.log=function(a){
		console.log(new Date().getTime()+" "+this.src+": "+a);
	}
	json2htmlajax.prototype.data={};
	json2htmlajax.prototype.exec=function(){
			...
			this.log('start');
			{
				...
				this.dscripts=
					[
						{
							"id":0,
							"src":"/lib/jquery/3.2.1/jquery.min.js"
						},
						{
							"id":1,
							"src":"https://cdnjs.cloudflare.com/ajax/libs/json2html/1.2.0/json2html.min.js"
						},
						{
							"id":2,
							"src":"https://cdnjs.cloudflare.com/ajax/libs/jquery.json2html/1.2.0/jquery.json2html.min.js"
						}
					]
				;
				this.tscripts={
				...
				//$(document.body).json2html([{'s':'json2html'},{'s':'is'},{'s':'awesome'}],{'<>':'li','html':'${s}'});
				_response.write(
					this._.template(this.tpl_page)({
						'contents':
						this._.template('<%= contents %><%= scripts %>')({
							contents:this._.template(this.tpl_contents)({
									title:this.name,
									contents:this._.template(
										'<div class="container"><%= contents %></div>'
									)({
										contents:this.json2html.transform(this.d,this.t)
									})
							}),
							scripts:this.json2html.transform(this.dscripts,this.tscripts)
						})
					})
				);
			}
	...
	json2htmlajax.prototype.update=function(){
		this.data.modified=new Date().getTime();
	}
	json2htmlajax.prototype.toJson=function(){
		var ret={};
		return ret;
	}
	json2htmlajax.prototype.toString=function(a,b){
		return JSON.stringify(this.toJson(),a==null?-1:a,b==null?'':b);
	}
	module.exports=json2htmlajax;
}
